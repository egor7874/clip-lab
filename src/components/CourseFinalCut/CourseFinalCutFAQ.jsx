...
const faqData = [
  {
    question: "1. Сколько длится курс?",
    answer: "В среднем курс длится 2 месяца и состоит из 5–6 модулей.",
  },
  {
    question: "2. Есть ли обратная связь?",
    answer: "Да, вы получите проверку заданий и ответы от наставника.",
  },
  {
    question: "3. Что такое интерактивные задания?",
    answer: "Конечно! Курс рассчитан на новичков и не требует опыта.",
  },
  {
    question: "4. Можно ли учиться с телефона?",
    answer: "Вам потребуется Final Cut Pro X (доступна демо-версия).",
  },
  {
    question: "5. Сколько времени нужно на курс?",
    answer: "Да, после прохождения всех модулей вы получите сертификат.",
  },
];
