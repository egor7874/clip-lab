...
export default function FCPXPro() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 w-full">
          ...
          <div className="md:max-w-[50%] w-full">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-6">
              Final Cut Pro X — <span className="text-[#FADF4B]">продвинутый уровень</span>
            </h1>
            <p className="mt-3 text-lg md:text-xl font-medium text-white/80 mb-8">
              Освой мультитреки, сложные эффекты и оптимизацию рабочих процессов в Final Cut.
            </p>
          ...
          <div className="md:max-w-[45%] w-full relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <img
                src={heroImage}
                alt="Final Cut Pro X — продвинутый уровень"
